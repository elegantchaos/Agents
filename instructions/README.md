...
These files are shared guidance modules used when rebuilding project `AGENTS.md` files from the common guidance set (`instructions/COMMON.md`, `codex/skills/agents-refresh/WORKFLOW.md`).
