...
license: MIT
metadata:
  author: Elegant Chaos, adapted from work by Paul Hudson
  version: "1.0"
---
...
- Prefer strict concurrency checking and current Swift concurrency features when the project toolchain supports them. Use the `swift:language` skill for baseline toolchain expectations.
