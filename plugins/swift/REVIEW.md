...
- All six skills are in the plugin as direct copies of our standalone skills and forks. Further change happens here, reviewed against upstream sources rather than merged from them.
...
- Plugin skills under `skills/`, formerly the `swift-skill`, `swiftui-skill`, `validation-flow-skill`, `Swift-Concurrency-Agent-Skill`, `Swift-Testing-Agent-Skill`, and `SwiftData-Agent-Skill` repositories. Paul Hudson's upstream repositories have newer changes (from April 2026) not yet reviewed.
