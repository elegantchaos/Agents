...
10. Verify the resulting shared files, runtime copies, final `default.rules` state, public skill status, and any concrete repo changes you make.
...
- each shared rule file has a corresponding generated regular runtime copy
- no shared rules file is named `default.rules`
